...
public class VentanaUbicacionUpdate extends JFrame {
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JTextField localidad;
	private JTextField provincia;
	private static VentanaUbicacionUpdate INSTANCE;
	private JTextField pais;
	private JLabel lblpais;
	private JButton btnAgregarLocalidad;

	public static VentanaUbicacionUpdate getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new VentanaUbicacionUpdate();
			return new VentanaUbicacionUpdate();
		} else
			return INSTANCE;
	}

	private VentanaUbicacionUpdate() {
		super();
