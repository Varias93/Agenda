...
public class VentanaUbicacioneInsert extends JFrame {
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JTextField localidad;
	private JTextField provincia;
	private static VentanaUbicacioneInsert INSTANCE;
	private JTextField pais;
	private JLabel lblpais;
	private JButton btnAgregarLocalidad;

	public static VentanaUbicacioneInsert getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new VentanaUbicacioneInsert();
			return new VentanaUbicacioneInsert();
		} else
			return INSTANCE;
	}

	private VentanaUbicacioneInsert() {
		super();
